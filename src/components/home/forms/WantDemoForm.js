...
function Header() {
  ...
  const onSubmit = (e) => {
    ...
    const fetchData = async () => {
      axios
        .post(
          `${process.env.REACT_APP_API_URL}/api/contacts/demo`,
          formData,
          config
        )
        .then((res) => {
  ...
  return (
    <main className="mt-8 mx-auto max-w-6xl px-4 sm:mt-12 sm:px-6 lg:mt-16">
      <div className="lg:grid lg:grid-cols-12 lg:gap-8">
        <div className="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left">
          <h1 className="text-5xl font-gilroy-black dark:text-white">
            New Skills for you
          </h1>
          <p className=" text-base font-gilroy-medium text-gray-500 mt-2 sm:mt-4 sm:text-xl lg:text-lg xl:text-xl">
            Learn python, javascript, react programming, hacking & a lot more!
          </p>
          <div className="mt-8 sm:max-w-lg sm:mx-auto sm:text-center lg:text-left lg:mx-0">
            <p className="text-base font-gilroy-medium text-gray-900 dark:text-dark-txt">
              Train 100% FREE, start today!
            </p>
...
{/* --- END Form */}
            ...
            <p className="mt-3 text-sm text-gray-500">
              ...
              <Link
                to="/privacidad"
                className="font-gilroy-medium text-gray-900 underline dark:text-dark-txt ml-1"
              >
                Privacy Policy
              </Link>
              .
