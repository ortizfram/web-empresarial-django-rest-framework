import FullWidthLayout from "hocs/layouts/FullWithLayout"
...
const people = [
    {
      ...
      bio: 'Me llamo Franco Ortiz, soy programador con mas de 12 años de experiencia. Vengo programando desde que estoy en el colegio, me gusta crear video juegos y aplicaciones web con Django Rest Framework, React y Ethereum.',
      twitterUrl: 'https://x.com/ortizfram',
      linkedinUrl: 'https://www.linkedin.com/in/ortizfram/',
      youtubeUrl: '#',
    },
    // More people...
  ]
        ...
        <FullWidthLayout>
            <div className="mx-auto pt-12 px-4 max-w-7xl sm:px-6 lg:px-8 lg:pt-24">
                ...
                <div className="space-y-5 sm:space-y-4">
                    ...
                    MelonBlog es una empresa de programacion dedicada al area de Educacion y Servicios. Nuestros cursos han ayudado a mas de 4.5 Millones de personas en todo el mundo.
                    </p>
                </div>
            ...
            <section aria-labelledby="features-heading" className="max-w-7xl mx-auto py-16 sm:px-2 lg:px-8">
                ...
                <div className="max-w-3xl">
                    ...
                    Our porfolio creations & deployments
                    </p>
                </div>
            ...
            <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
                ...
                <div>
                    ...
                    We offer Web page creation & ecommerce platforms.
                    </p>
